...
def generator(batch):
    while True:
        ...
        for i in range(batch): # Batch
            image, texts, bounds = generate_image(size=(WIDTH, HEIGHT), texts=TEXTS, text_width=(7,9),
...
def main():
    ...
    for i, (x, r) in enumerate(zip(x_devs, results)):
        ...
        image.save('outputs/bisque_{:%Y%m%d-%H%M}_{:02d}.png'.format(now, i))
